...
public class TangGiamCaoNhatGiuaPhienSang extends MauCauDuaTrenBigStock implements iMauCau{
	...
	public String sinhCau() {
		...
		if(chenhLech >= 0) {
			...
			sb.append(dauCau); sb.append(symbol); sb.append(giuaCau1); sb.append(String.format("%.2g", chenhLech)); sb.append(giuaCau2);
