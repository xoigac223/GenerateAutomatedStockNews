...
public class MauCauChotNgay extends MauCauDuaTrenSEvaBS implements iMauCau{
	...
	public MauCauChotNgay(BigStock stock, StockExchange stockExchange, String tag) {
		super(stock, stockExchange);
		this.tag = tag;
	...
	public String sinhCau() {
		if (tag.equals("Ngày")) return sinhCauNgay();
		else if (tag.equals("Tuần")) return sinhCauTuan();
		else if (tag.equals("Tháng")) return sinhCauThang();
		else if (tag.equals("Quý")) return sinhCauQuy();
		else if (tag.equals("Năm")) return sinhCauNam();
		else return null;
	}
	//Ngày
	public String sinhCauNgay() {
